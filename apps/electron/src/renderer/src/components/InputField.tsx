const InputField = ({
  ...
  const variantStyles = {
    primary:
      'bg-[#fafafa] border border-gray-300 text-center text-[#212121] focus:ring focus:ring-gray-300',
    secondary:
      'bg-[#585858] border border-gray-600 text-center text-white focus:ring focus:ring-green-300',
    tertiary:
      'bg-[#000] border border-[#3d3d3d] text-center text-white focus:ring focus:ring-gray-300',
